                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-500 mt-1">
                          {isDelete ? 'This action cannot be undone' : 'Update subject details'}
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  {isDelete ? (
                    ...
                    <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-4 mb-6">
                      ...
                      <p className="text-amber-400 font-mono text-lg mb-3">{subjectName}</p>
                      <div className="space-y-2 text-sm text-zinc-400">
                        ...
                        <p className="flex items-start gap-2">
                          <span className="text-red-400 mt-1">•</span>
                          <span>This subject will be removed from your timetable</span>
                        </p>
                        <p className="flex items-start gap-2">
                          <span className="text-red-400 mt-1">•</span>
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            type="button"
                            onClick={() => setEditData({ ...editData, type: 'lecture' })}
                          ...
                          <button
                            type="button"
                            onClick={() => setEditData({ ...editData, type: 'lab' })}
                            className={`p-4 rounded-lg border-2 transition ${
                              editData.type === 'lab'
                  ...
                  <form onSubmit={handleConfirmAction} className="space-y-4">
                    ...
                    <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                      <p className="text-xs text-zinc-400">
                        For security reasons, you must verify your identity before{' '}
                        {isDelete
                      ...
                      >
                        {verifying || loading ? (
                          <>
                            ...
                            />
                            <span>
                              {verifying ? 'Verifying...' : isDelete ? 'Deleting...' : 'Saving...'}
                            </span>
                          </>
                        ) : (
                          <>
