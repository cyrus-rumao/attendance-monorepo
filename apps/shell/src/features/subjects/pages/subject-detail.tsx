...
const SubjectDetail: React.FC = () => {
  ...
  const { selectedSubject: data, loading, getSubjectAnalytics } = useSubjectStore();
  ...
  const getProgressBarColor = (percentage: number): string => {
    if (percentage >= 75) return 'bg-linear-to-r from-green-500 to-emerald-500';
    if (percentage >= 70) return 'bg-linear-to-r from-yellow-500 to-amber-500';
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-light text-white mb-2">Subject not found</h3>
          <button
            onClick={() => navigate(-1)}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-4xl font-light text-white">{subject.name}</h1>
                <span
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-3xl font-light text-white">{analytics.totalConductedHours}</div>
          ...
          <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-3xl font-light text-green-400">{analytics.attendedHours}</div>
            <div className="text-xs text-zinc-500 mt-1">hours</div>
          </div>
          ...
          <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-3xl font-light text-red-400">{analytics.absentHours}</div>
            <div className="text-xs text-zinc-500 mt-1">hours</div>
          </div>
          ...
          <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-xl p-4">
            ...
            <div className="text-3xl font-light text-orange-400">{analytics.bunkedHours}</div>
            <div className="text-xs text-zinc-500 mt-1">hours</div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-2xl p-8">
            ...
            <div className="flex items-center gap-8 mb-8">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-green-400 font-medium">{analytics.attendedHours} hrs</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="space-y-2">
              ...
              <div className="w-full h-3 bg-zinc-800 rounded-full overflow-hidden">
                <div className={getProgressBarColor(analytics.attendancePercentage)} />
              </div>
            ...
            {analytics.attendancePercentage >= 75 ? (
              <div className="bg-linear-to-br from-green-900/20 to-black border border-green-500/30 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-medium text-white">You're Safe!</h3>
                </div>
                ...
                {analytics.safeBunkHours > 0 && (
                  <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                    ...
                    <div className="text-2xl font-light text-green-400">
                      {analytics.safeBunkHours} {analytics.safeBunkHours === 1 ? 'hour' : 'hours'}
                    </div>
                    <p className="text-xs text-zinc-500 mt-2">While staying above 75%</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-linear-to-br from-blue-900/20 to-black border border-blue-500/30 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-medium text-white">Fresh Start</h3>
                </div>
                <p className="text-zinc-400 text-sm mb-4">
              ...
              <div className="bg-linear-to-br from-red-900/20 to-black border border-red-500/30 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-medium text-white">Action Needed</h3>
                </div>
                <p className="text-zinc-400 text-sm mb-4">
                ...
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                  ...
                  <p className="text-xs text-zinc-500 mt-2">To reach 75% attendance</p>
                </div>
              </div>
            )}
            ...
            <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-orange-400 font-medium">{analytics.bunkedHours}</span>
                </div>
                <div className="flex items-center justify-between">
