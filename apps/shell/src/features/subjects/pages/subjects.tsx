      ...
      <div className="border-b border-zinc-900 bg-zinc-950/50 backdrop-blur-xl sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-light text-white mb-2">My Subjects</h1>
              <p className="text-zinc-400">Manage your courses and track attendance</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-light text-white mb-2">No subjects found</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-light text-white">{subjects.length}</div>
              ...
              <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-light text-white">{lectures.length}</div>
              ...
              <div className="bg-linear-to-br from-zinc-900 to-black border border-zinc-800 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-light text-white">{labs.length}</div>
